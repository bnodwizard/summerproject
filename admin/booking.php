...
<div class="content-box-large" style="margin-left: 220px; margin-top: -305px;" >
    ...
    <?php
					...
					mysql_select_db('book');
						...
						$result = mysql_query($query);
								...
								echo "<table align='center' class='table table-hover table-striped' id='example' align='center' style='margin-top:-250px';>";
									echo "<thead>";
										echo "<tr>";
    ...
    <div class="content-box-large" style="margin-left: 220px;">
  				<div class="panel-heading">
					<div class="panel-title">All Booking</div>
				</div>
  				<div class="panel-body">
  					<div class="table-responsive">
